...
/* harmony default export */ __webpack_exports__["default"] = ("<app-quotes></app-quotes>");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/quotes-detail/quotes-detail.component.html":
/*!**************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/quotes-detail/quotes-detail.component.html ***!
  \**************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<p>{{quotes.description}}</p>\n<p> {{quotes.completeDate|dateCount}} </p>\n<button (click)= 'quotesDelete(true)' class=\"btn btn-outline-danger\">Delete quote</button>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container-fluid\">\n  <h2 class=\"text-center\">CREATE YOUR QUOTE.</h2>\n  <hr>\n  <form (ngSubmit)='submitQuotes(quotesForm.value)'  #quotesForm='ngForm'>\n   <div class=\"form-group\">\n    <label for=\"submiter\">Write your Quote</label>\n    <textarea  cols=\"30\" rows=\"10\" required [(ngModel)]=\"newQuotes.submiter\" class=\"form-control\" name=\"submiter\" #submiter=\"ngModel\" id=\"submiter\" type=\"text\" class=\"form-control\"> </textarea>\n    <div class=\"alert alert-danger\" *ngIf=\"submiter.touched && !submiter.valid\">the quote is required</div>\n</div>\n<div class=\"form-group\">\n    <label for=\"auother\">Aouther's Name</label>\n    <input required [(ngModel)]=\"newQuotes.auother\" class=\"form-control\" name=\"auother\" #auother=\"ngModel\" id=\"auother\" type=\"text\" class=\"form-control\">\n    <div class=\"alert alert-danger\" *ngIf=\"auother.touched && !auother.valid\">Auother name is required</div>\n</div>\n<div class=\"form-group\">\n  <label for=\"quote\">Submitter</label>\n  <input required [(ngModel)]=\"newQuotes.quote\" class=\"form-control\" name=\"quote\" #quote=\"ngModel\" id=\"quote\"\n    class=\"form-control\">\n  <div class=\"alert alert-danger\" *ngIf=\"quote.touched && !quote.valid\">The submitter name is required</div>\n</div>\n<button type=\"submit\" class=\"btn btn-primary\">submit</button>\n</form>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"container\">\n    <h1>KEEP QUOUTES.</h1>\n    <hr>\n  \n    <div class=\"row\">\n      <div class=\"col-md-12\">\n        <div *ngFor='let quotes of quotes;let i = index'>\n          <div>\n            <h4 id={{i}} appStrikethrough>{{quotes.name}}  {{quotes.completeDate|date|uppercase}}</h4>\n            <button (click)='toggleDetails(i)' class=\"btn btn-primary\">View Details</button>\n          </div>\n  \n          <div *ngIf='quotes.showDescription'>\n            <app-quotes-detail  [quotes]='quotes' (isComplete) = 'deleteQuotes($event,i)'></app-quotes-detail>\n          </div>\n        </div>\n        <div class=\"col-md-12\">\n            <app-quotes-form (addQuotes)=\"addNewQuotes($event)\"></app-quotes-form>\n    </div>\n      </div>\n    </div>\n  </div>");
...
let AppComponent = class AppComponent {
    constructor() {
        this.quotes = [
            new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](1, 'Be yourself everyone else is already taken', 'by Oscar Wilde the quote was submited by osman', new Date(2020, 3, 14)),
            new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](2, 'Be the change that you ', 'wish to see in the world', new Date(2019, 6, 9)),
        ];
    }
};
...
/* harmony import */ var _quotes_detail_quotes_detail_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./quotes-detail/quotes-detail.component */ "./src/app/quotes-detail/quotes-detail.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _quotes_detail_quotes_detail_component__WEBPACK_IMPORTED_MODULE_7__["QuotesDetailComponent"],
...
/***/ "./src/app/quotes-detail/quotes-detail.component.css":
/*!***********************************************************!*\
  !*** ./src/app/quotes-detail/quotes-detail.component.css ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3F1b3Rlcy1kZXRhaWwvcXVvdGVzLWRldGFpbC5jb21wb25lbnQuY3NzIn0= */");

/***/ }),

/***/ "./src/app/quotes-detail/quotes-detail.component.ts":
/*!**********************************************************!*\
  !*** ./src/app/quotes-detail/quotes-detail.component.ts ***!
  \**********************************************************/
/*! exports provided: QuotesDetailComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuotesDetailComponent", function() { return QuotesDetailComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let QuotesDetailComponent = class QuotesDetailComponent {
    constructor() {
        this.isComplete = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    quotesDelete(complete) {
...
], QuotesDetailComponent.prototype, "quotes", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], QuotesDetailComponent.prototype, "isComplete", void 0);
QuotesDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-quotes-detail',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./quotes-detail.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/quotes-detail/quotes-detail.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./quotes-detail.component.css */ "./src/app/quotes-detail/quotes-detail.component.css")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3F1b3Rlcy1mb3JtL3F1b3Rlcy1mb3JtLmNvbXBvbmVudC5jc3MifQ== */");
...
let QuotesFormComponent = class QuotesFormComponent {
    constructor() {
        this.newQuotes = new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](0, "", "", new Date());
        this.addQuotes = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    submitQuotes(form) {
        console.log(form);
        this.addQuotes.emit(new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](form.auother, form.submiter, form.quote, new Date()));
    }
    ngOnInit() {
    }
};
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
], QuotesFormComponent.prototype, "addQuotes", void 0);
...
let QuotesComponent = class QuotesComponent {
    constructor() {
        this.quotes = [
            new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](1, 'Be yourself everyone else is already taken', 'by Oscar Wilde the quote was submited by osman', new Date(2020, 3, 14)),
            new _quotes__WEBPACK_IMPORTED_MODULE_2__["Quotes"](2, 'Be the change that you wish to see in the world', 'Mahatma Gandhi', new Date(2019, 6, 9)),
        ];
    }
    addNewQuotes(quotes) {
...
module.exports = __webpack_require__(/*! /home/osman/quotes/src/main.ts */"./src/main.ts");
